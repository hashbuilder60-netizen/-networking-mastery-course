...
- Apply network security controls and segmentation.
- Automate network tasks with Python and APIs.
- Monitor network performance and troubleshoot systematically.
...
│  ├─ 01-foundations/
│  ├─ 02-network-models/
│  ├─ 03-addressing-subnetting/
│  ├─ 04-switching-vlans/
│  ├─ 05-routing-static-dynamic/
│  ├─ 06-transport-services/
│  ├─ 07-network-services/
│  ├─ 08-wireless/
│  ├─ 09-security/
│  ├─ 10-automation-programmability/
│  ├─ 11-cloud-sdn/
